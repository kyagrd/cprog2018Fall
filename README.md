 ...
 * [Mingw-w64](http://mingw-w64.org/)
     * 리눅스나 맥 사용자들이 아닌 윈도우즈 사용자들에게만 필요한 내용으로 gcc 컴파일러 및 디버거 등이 포함된 패키지이다.
     * Download 에서 MingW-W64-builds 를 클릭해서 나오는 페이지를 따라가서 설치한다.
 * [Code::Blocks](http://www.codeblocks.org/)
     ...
     * 윈도우즈에서 Visual C/C++ 개발환경에 익숙한 사람의 경우 본인이 정말로 강력하게 원한다면 그것을 사용해서 실습해도 되지만 Mingw-W64-builds 패키지에 포함횐 gcc 8.1.0과 호환되지 않는 C/C++ 코드를 제출할 경우 프로그래밍 관련 점수를 받지 못하게 될 큰 위험부담을 본인이 감수하고 그로 인한 불이익에 대해서는 스스로가 책임질 각오를 한 경우에만 Visual C/C++을 사용해서 실습하면 된다.
